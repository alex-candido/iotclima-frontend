...
import { StationSensorEventsTab } from "@/components/admin/station-sensors/station-sensor-events-tab";
import { StationSensorRecordsTab } from "@/components/admin/station-sensors/station-sensor-records-tab";
