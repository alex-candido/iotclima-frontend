// src/components/pages/admin/sensors/sensor-detail-header-section.tsx
"use client";
...
interface SensorDetailHeaderSectionProps {
  isLoading: boolean;
  sensorId: number | string;
  sensor: Sensor;
}

export function SensorDetailHeaderSection({
  isLoading,
  sensorId,
  sensor,
}: SensorDetailHeaderSectionProps) {
  ...
  const pageTitle =
    APP_TEXT.SENSORS_PAGE.DETAIL_TITLE || `Detalhes do Sensor: ${sensor.model}`;
  const pageDescription =
    APP_TEXT.SENSORS_PAGE.DETAIL_DESCRIPTION ||
    ...
    <div className="flex items-center gap-4">
      ...
      <div className="flex gap-2">
        {sensorId && sensor && canEditSensor && (
          <Link href={APP_ROUTES.ADMIN.SENSORS.EDIT(sensorId)}>
