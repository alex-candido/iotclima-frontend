// src/components/pages/admin/stations/edit-station-header-section.tsx
"use client";
...
interface EditStationHeaderSectionProps {
  isLoading: boolean;
  stationId: number | string;
  station: Station;
}

export function EditStationHeaderSection({
  isLoading,
  stationId,
  station,
}: EditStationHeaderSectionProps) {
    ...
    <div className="flex items-center gap-4">
      ...
      <div className="flex gap-2">
        {stationId && station && canEditStation && (
          <Link href={APP_ROUTES.ADMIN.STATIONS.DETAIL(stationId)}>
