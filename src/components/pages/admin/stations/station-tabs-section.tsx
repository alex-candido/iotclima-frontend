...
import { StationDataLogTab } from "@/components/pages/admin/stations/station-data-log-tab";
import { StationDataRecordsTab } from "@/components/pages/admin/stations/station-data-records-tab";
import { StationSensorsTab } from "@/components/pages/admin/stations/station-sensors-tab";
