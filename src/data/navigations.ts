...
export const ADMIN_SIDEBAR_LINKS: NavLink[] = [
  ...
  { href: APP_ROUTES.ADMIN.STATION_SENSORS.LIST, label: APP_TEXT.ADMIN_LAYOUT.STATION_SENSORS_LINK, icon: APP_ROUTES.ADMIN.STATION_SENSORS.icon, roles: APP_ROUTES.ADMIN.STATION_SENSORS.roles },
